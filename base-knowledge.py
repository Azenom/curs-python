...
#     required_fields = [
#         'cnp','firstname','lastname','rom','math','engl'
#     ]
...
# @app.post('/students')
# def create_student():
#     data = request.get_json(silent=True) or {} # daca fisierul primit e ok atunci il prinde in json altfel in pune in dictionar
...
# @app.put('/students/<int:student_cnp>')
# def update_student(student_cnp):
...
#             '''
#             UPDATE students
#             SET cnp = ?, firstname = ?, lastname = ?, rom = ?, math = ?, engl = ?
#             WHERE cnp = ?
#             ''',
#             (
#                 data['cnp'],
...
#         cursor.exeute('DELETE FROM students WHERE cnp = ?', (student_cnp,))
#         connection.commit()
...
# print(response.json)
# response = requests.delete(f'{base_url}/students/123123123123')
# print(response.json)
